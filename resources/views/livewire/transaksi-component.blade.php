            ...
            <div class="row">
                @foreach ($mobil as $data)
                                <div class="col-md-4">
                                    ...
                                    <img src="{{ asset('storage/mobil/' . $data->foto) }}" style="height: 200px;" "width="200px" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $data->merk }}</h5>
                                        
                                    </div>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Nomor Polisi : {{ $data->nopolisi }}</li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        class="btn btn-sm btn-success card-link">PILIH MOBIL</button>
